...
void draw() {
  ...
  if (FjernStart) {
    ...
    text("Tryk Start og derefter enter for at starte spil", 300, 750);
  } else {
...
void OpdelIBunker() {
  ...
  print(Bunke1[0]);
  image(BBunke1[0], 490, 460, 300, 300);
  print(Bunke2[0]);
  image(BBunke2[0], 490, 140, 300, 300);

  image(BagsidenAfKort, 20, 30, 200, 200);
  image(BagsidenAfKort, 30, 30, 200, 200);
  image(BagsidenAfKort, 40, 30, 200, 200);

  image(BagsidenAfKort, 1030, 600, 200, 200);
  image(BagsidenAfKort, 1020, 600, 200, 200);
  image(BagsidenAfKort, 1010, 600, 200, 200);
}
